...
const Carousal = (props: Props) => {
  return (
    <div className="flex flex-col gap-y-12 mx-auto">
      ...
      <div className="border border-gray-300 text-gray-600 text-[20px] font-medium px-[34px] py-[16px] w-[273px] mx-auto  text-center rounded-[13px] cursor-pointer bg--200">
        View recent work
      </div>
    </div>
  );
